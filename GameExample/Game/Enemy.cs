...
namespace Platformer2D
{
    ...
    class Enemy
    {
        ...
        {
            get { return state.WaitTime; }
            set { state.WaitTime = value; }
        }
        ...
        /// </summary>
        public Enemy(Level level, EnemyState state)
        {
            this.level = level;
            this.state = state;

            LoadContent(state.SpriteSet);
        }
        ...
        public void LoadContent(string spriteSet)
        {
            ...
            sprite.PlayAnimation(this.idleAnimation);
